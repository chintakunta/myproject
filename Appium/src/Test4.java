...
public class Test4 {
	...
	public static void main(String[] args) throws Exception {
		...
		try
		{
			...
			/*String z=driver.findElement(By.xpath("(//*[@class='android.widget.HorizontalScrollView' or @class='android.widget.TextView']")).getAttribute("text");
			Thread.sleep(10000);*/
			String z=driver.findElement(By.xpath("(//*[@class='android.widget.LinearLayout'])[0]")).getAttribute("text");
			Thread.sleep(10000);
			//String z = driver.findElementByAndroidUIAutomator("new UiSelector().className(\"android.widget.LinearLayout \")").getAttribute("text");
