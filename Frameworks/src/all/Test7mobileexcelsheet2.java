...
public class Test7mobileexcelsheet2 
{
	public static void main(String[] args) throws Exception 
	{
		//open excel file for reading
				...
				WritableSheet wsh=wwb.getSheet(1);//0 for sheet1
				//Details of mobile 
				...
				while(2>1)
				{
				   ...
				   {
					   Date d=new Date();
						Label l1=new Label(0,0,"Result on"+d.toString());
						wsh.addCell(l1);
				       ...
				       if(y.contains(x))
				       {
				    	   Label l2=new Label(0,i,"Test Passed");
				    	   wsh.addCell(l2);
				       }
				       else
						{
